# Symfony Flex Recipe for Password Policy Bundle

This directory contains the Symfony Flex recipe for the Password Policy Bundle.
...
2. **Create the default configuration file** at `config/packages/nowo_password_policy.yaml`
...
2. Copy the recipe directory to `contrib/nowo-tech/password-policy-bundle/1.0.0/`
...
1. Create a repository with the structure: `recipes/nowo-tech/password-policy-bundle/1.0.0/`
...
├── config/
│   └── packages/
│       └── nowo_password_policy.yaml  # Default configuration
