...
-- Create database if it doesn't exist (MySQL usually creates it automatically via MYSQL_DATABASE env var)
-- CREATE DATABASE IF NOT EXISTS password_policy_demo;
-- USE password_policy_demo;
