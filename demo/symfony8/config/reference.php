 ...
 *         reset_password_route_name?: scalar|Param|null, // The route name for password reset. This route will be used when redirect_on_expiry is enabled. Must be a valid route name in your application.
